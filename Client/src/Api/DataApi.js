...
class Data {
    ...
    async DeletePartie(data) {
        ...
        try {
            const result = await axios.put(`${this.url}/delete-partie`, data, {
                withCredentials: true,
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async DeleteItem(data) {
        try {
            const result = await axios.delete(`${this.url}/delete-item`, data, {
                withCredentials: true,
                headers: {
                    'Content-Type': 'application/json',
                },
...
const dataApi = new Data('http://localhost:3001')
